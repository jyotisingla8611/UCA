#include<stdio.h>
// It is Divide nd Conquer sorting Algo
// Quick sort is INPLACE  i.e no need for extra array
...
/* This function takes last element as pivot, and places all smaller
   ...
   //Pivot element can be first or last element of array
...
int partition (int array[], int start, int end)
{
  ...
  swap(&array[i + 1], &array[end]);    // place pivot element at end of smaller elements
